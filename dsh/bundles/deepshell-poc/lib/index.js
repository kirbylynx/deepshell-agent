...
export function apply(ctx) {
  ...
  if (!instanceId || !readyFile) throw new Error('deepshell-poc: desktop handshake environment missing')
  ctx.on('webserver/index-inject', table => {
    table.push({ kind: 'global', name: '__DEEPSHELL_INSTANCE_ID__', value: instanceId })
  })
  ctx.effect(() => ctx.webServer.tapIndex(injectCsp), 'deepshell-poc: strict CSP')
  ...
  }), 'deepshell-poc: client ready route')
}
