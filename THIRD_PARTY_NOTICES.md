...
| `@yao-pkg/pkg` Enhanced SEA packager/bootstrap | 6.22.0 | MIT | locked in `pnpm-lock.yaml`; the embedded bootstrap carries a repository patch whose exact SHA256 is locked in `runtime/manifest/runtime-lock.json` |
