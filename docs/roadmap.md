...
| QA-011 | Performance Regression | Startup, memory, package size, and response trends | P2 | Planned (v0.1.5; partially implemented in v0.1.4): retain the implemented v0.1.4 package-size/file-count baseline and add SEA startup, memory, installed/generated-file, and native-cache regression measurements; unrelated network-model response benchmarking remains outside this version |
