...
const currentSharedSourceInputs = [
  ...
  'scripts/lib/package-baseline.mjs',
  'scripts/lib/package-baseline.d.mts',
  ...
  'scripts/lib/sea-runtime.mjs',
  'scripts/lib/sea-runtime.d.mts',
  'scripts/lib/process-plan.mjs',
  'scripts/lib/process-plan.d.mts',
  'scripts/lib/redaction.mjs',
  'scripts/lib/runtime-acceptance.mjs',
  'scripts/lib/runtime-acceptance.d.mts',
  'scripts/lib/runtime.mjs',
  'scripts/lib/source-inputs.mjs',
...
export const platformSourceInputs = {
  ...
  'win32-x64': [
    ...
    'scripts/create-windows-portable.d.mts',
    'scripts/package-windows-installed-tree.mjs',
    'scripts/package-windows-installed-tree.d.mts',
...
// v0.1.4 canonical baseline 的输入集合必须是 tag 当时的精确列表。这里故意使用
// 完整字面量，不能从 currentSharedSourceInputs 派生，否则 v0.1.5 新增文件会污染历史摘要。
export const v014BaselineSourceInputs = [
  '.gitattributes',
  'package.json',
  'pnpm-lock.yaml',
  'rust-toolchain.toml',
